...
//  OneFeed
//
//  Created by Pavly Habashy on 12/3/18.
//  Copyright © 2018 Pavly Habashy. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    TWTRTwitter.sharedInstance().start(withConsumerKey:"zEXzPKsbyqJfy4i2caoCpO5Zh", consumerSecret:"CWuJ4dnQXR4wkRhlajq6xSqif9RnCWHfhu0H8K7FeuR7f5Ftre")
